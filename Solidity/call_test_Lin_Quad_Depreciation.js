...
const Constant = contract.methods.createDataReference(1000000000000,1800,byt,0,"Constant").encodeABI();
// const getDataRef = contract.methods.getDataReferences(0)5encodeABI();


const Linear = contract.methods.createDataReference(1000000000000,1800,byt,1,"Linear").encodeABI();
// const getDataRef = contract.methods.getDataReferences(0)5encodeABI();


const Quad = contract.methods.createDataReference(1000000000000,1800,byt,2,"Quad").encodeABI();
// const getDataRef = contract.methods.getDataReferences(0)5encodeABI();
