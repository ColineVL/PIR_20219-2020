...
const Constant = contract.methods.createDataReference(1000000000000,3600000,byt,0,"Constant").encodeABI();
// const getDataRef = contract.methods.getDataReferences(0)5encodeABI();


const Linear = contract.methods.createDataReference(1000000000000,3600,byt,1,"Linear").encodeABI();
// const getDataRef = contract.methods.getDataReferences(0)5encodeABI();


const Quad = contract.methods.createDataReference(1000000000000,360000,byt,2,"Quad").encodeABI();
// const getDataRef = contract.methods.getDataReferences(0)5encodeABI();

const TLE1 = contract.methods.setTLE(0, "Satname", "Hello").encodeABI();
// const getDataRef = contract.methods.getDataReferences(0)5encodeABI();

const TLE2 = contract.methods.setTLE(0, "Satname2","Hey").encodeABI();
// const getDataRef = contract.methods.getDataReferences(0)5encodeABI();

const TLE3 = contract.methods.setTLE(4000, "Satname3","Heyyy").encodeABI();
// const getDataRef = contract.methods.getDataReferences(0)5encodeABI();
